...
export const apiKeys = sqliteTable('api_keys', {
  ...
  key_preview: text('key_preview'),
  name: text('name'),
  purpose: text('purpose').notNull().default('chat'),
  enabled: integer('enabled').notNull().default(1),
  quota_tokens: integer('quota_tokens').notNull().default(-1),
  used_tokens: integer('used_tokens').notNull().default(0),
  expired_at: integer('expired_at'),
  allowed_models: text('allowed_models'),
  rpm_limit: integer('rpm_limit'),
  created_at: integer('created_at'),
